...
function getReplyFromChatbot() {
    ...
    let chatbotMshEl = document.createElement('span');
    chatbotMshEl.textContent = chatbotMsg;
    chatbotMshEl.classList.add('msg-from-chatbot');
    msgContainerEl.appendChild(chatbotMshEl);
